...
class AtivitiColors {
  static Color black = Color(0xff343434);
  static Color dusk = Color(0xff3c506b);
  static Color paleGrey = Color(0xfff2f5f9);
  static Color coralPink = Color(0xffff5a5f);
  static Color lightBlueGrey = Color(0xffb5c5da);
